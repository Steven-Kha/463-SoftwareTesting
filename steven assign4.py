...
class NameExtractor():
    ...
    def FindMiddleName(self):
       ...
       #    return True
        if (len(self.mWords) == 5 or len(self.mWords) == 4) and (self.mSuffix == ""):
            self.mMiddleName = self.mWords[2]
            return True
        if (len(self.mWords) == 4 and self.mTitle == "") or (len(self.mWords) == 4 and self.mSuffix == ""):
            self.mMiddleName = self.mWords[1]
            return True
        if (len(self.mWords) == 3) and (self.mSuffix == "") and (self.mTitle == ""):
            self.mMiddleName = self.mWords[1]
        else:
            return False
    ...
    def FindLastName(self):
        if len(self.mWords) == 1:
            ...
            return True
        if len(self.mWords) == 2:
            self.mLastName = self.mWords[1]
            return True
        if len(self.mWords) == 5:
            self.mLastName = self.mWords[3]
            return True
        if (len(self.mWords) == 3 and self.mSuffix == "") or (len(self.mWords) == 4and self.mSuffix != ""):
            self.mLastName = self.mWords[2]
            return True
        else:
            if len(self.mWords) == 3:
                self.mLastName = self.mWords[1]
            else:
                if (len(self.mWords) == 4):
                    self.mLastName = self.mWords[2]
                    return True
        return False
